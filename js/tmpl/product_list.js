$(function(){
    ...
    if($("input[name=gc_id]").val()!=''){
    	$.ajax({
    		url:ApiUrl+"/index.php?act=goods&op=goods_list&token="+token+"&key=4&page="+pagesize+"&curpage=1"+'&gc_id='+$("input[name=gc_id]").val(),
    		type:'get',
    		dataType:'json',
    ...
    $("select[name=page_list]").change(function(){
    	...
    	if(gc_id>0){
    		var url = ApiUrl+"/index.php?act=goods&op=goods_list&token="+token+"&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&gc_id="+gc_id;
    	}else{
	...
	$('.keyorder').click(function(){
		...
		if(gc_id>0){
			var url = ApiUrl+"/index.php?act=goods&op=goods_list&token="+token+"&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&gc_id="+gc_id;
		}else{
