$(function(){
	...
	$('#loginbtn').click(function(){	
		...
		var  invitedtel = $("input[name=invited]").val();
		...
		if($.sValid()){
			$.ajax({
				...
				data:{username:username,password:pwd,password_confirm:password_confirm,client:client,tel:invitedtel},
				dataType:'json',
	...
	$('#send_code').on('click',function(){
		...
		$.post(ApiUrl+"/index.php?act=login&op=send_reg",{mobile:$('#username').val(),type:'reg'},function(data){
			console.log(data);
			if (data.datas.error) {
